...
exports.buildRendererToolBundleOutputEvent = buildRendererToolBundleOutputEvent;
exports.markRendererToolEventDisplayOnly = markRendererToolEventDisplayOnly;
exports.routeSdkToolEventToLocalRuntime = routeSdkToolEventToLocalRuntime;
exports.resolveToolCallRequestId = resolveToolCallRequestId;
...
async function capturePostActionScreenshot(deps, { waitSeconds, explanation, turnRef, conversationRef, }) {
...
async function attachSinglePostActionScreenshot(deps, { toolName, args, data, turnRef, conversationRef, }) {
    const normalizedData = normalizeLocalToolResultData(data);
    if (isExplicitScreenshotTool(toolName)
...
async function attachBundlePostActionScreenshot(deps, { executedSteps, resultPayload, turnRef, conversationRef, }) {
...
function buildRendererToolOutputEvent(event, payload, startedAt) {
    ...
    return {
        ...
        payload: {
            ...
            screenshot_ref: (typeof data.screenshot_ref === 'string'
                ? data.screenshot_ref
...
function buildRendererToolBundleOutputEvent(event, payload, startedAt) {
    ...
    return {
        ...
        payload: {
            ...
            screenshot_ref: (typeof payload?.screenshot_ref === 'string'
