...
- Tool execution is delegated to a local Python sidecar via JSON-RPC in `frontend/src/main/local_backend_bridge.cjs` and `frontend/src/main/python/local_backend.py`.
- Wakeword is a dedicated Python subprocess bridge in `frontend/src/main/wakeword_bridge.cjs`.
