...
| OpenAI Codex OAuth state | Electron main OAuth helper plus backend config resolution | `frontend/src/main/openai_codex_oauth.cjs`, `frontend/src/main/ipc.cjs`, `backend/src/core/config/loader.py`, `backend/src/core/config/models.py` | `tests/frontend/OpenAICodexOAuth.test.cjs`, `tests/backend/test_config_loader.py` | [OpenAI Provider](../providers/openai.md) |
...
- `frontend/src/main/openai_codex_oauth.cjs` for auth flow, callback parsing, token/profile shape, and persistence.
