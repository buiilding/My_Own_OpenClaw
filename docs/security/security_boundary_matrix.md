...
read_when:
  - When a change crosses backend, desktop host, renderer, local-runtime, Python sidecar implementation, or SDK trust boundaries or touches auth, validation, credentials, permissions, or local tool execution.
