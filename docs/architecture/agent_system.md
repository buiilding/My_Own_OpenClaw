...
- `backend/src/agent/session/session_config_service.py` — `SessionConfigService` owns user config overrides, desktop client operating-system prompt rewrites, and effective session-config assembly.
