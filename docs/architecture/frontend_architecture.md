...
- `app/runtime/desktopConversationContinuityService.ts` and `app/runtime/desktopConversationLibraryClient.ts`: replay, rehydrate, list/load/delete/search through the SDK `SidecarConversationStore` via the desktop conversation store factory.
