...
| Electron main | windows, overlays, endpoint selection, websocket relay, config persistence, permission probes, sidecar lifecycle, wakeword bridge, VM worker runtime | `frontend/src/main` | [Frontend Architecture](frontend_architecture.md), [Frontend Main Docs Hub](../frontend/main/README.md) |
