...
| Sidecar transcript/memory SQLite | Python sidecar memory store | `frontend/src/main/python/memory/local_store.py`, `sqlite_store.py`, `operations.py`, `local_backend_memory_handlers.py` | `tests/sidecar/test_local_store*.py`, `test_memory_operations.py`, `test_memory_service.py` | [Sidecar Local Memory](../memory/sidecar_local_memory.md) |
...
| Browser-local files | Python sidecar browser runtime | `frontend/src/main/python/tools/browser/file_store.py`, `windie_runtime.py` | sidecar browser tool/action tests | [Browser Change Workflow](../browser/browser_change_workflow.md) |
