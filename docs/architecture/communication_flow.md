...
- Payload: `{ model_mode?, model_provider?, selected_model_id?, interaction_mode?, voice_mode_enabled?, speech_mode_enabled?, wakeword_stt_enabled?, agent_full_sudo_enabled?, include_query_screenshot? }`
