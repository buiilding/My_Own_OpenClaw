...
| Renderer showed a tool call but nothing executed | Did the backend event normalize into the SDK tool coordinator with live request/bundle IDs? | [Tool Execution Lifecycle](../tools/tool_execution_lifecycle.md), [Frontend Tool Execution Service](../frontend/renderer/infrastructure/tool_execution_service_and_hook_runtime_reference.md) |
