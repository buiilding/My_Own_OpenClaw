...
| sidecar runtime | `WINDIE_PYTHON_PATH`, `WINDIE_SIDECAR_LOG_LEVEL` / `AGENT_SIDECAR_LOG_LEVEL`, `WINDIE_VERBOSE_LOCAL_RUNTIME_STDERR`, `WINDIE_INTERACTIVE_WORKERS` / `AGENT_INTERACTIVE_WORKERS`, `WINDIE_BACKGROUND_WORKERS` / `AGENT_BACKGROUND_WORKERS`, `WINDIE_SHELL_JOB_TTL_SECONDS` / `AGENT_SHELL_JOB_TTL_SECONDS` |
