...
| Hosted URL, websocket auth, CORS, install token, or health check fails | Backend gateway/API and Electron endpoint forwarding | `backend/src/api`, `backend/src/api/auth`, `frontend/src/main`, `frontend/src/renderer/infrastructure/api` | Backend route/auth tests plus frontend endpoint tests | [API Route Change Workflow](../backend/api/api_route_change_workflow.md), [Main Process Change Workflow](../frontend/main/main_process_change_workflow.md), [Gateway Hub](../gateway/README.md), [Hosted API and Auth](../web/hosted_api_and_auth.md), [Endpoint and Network Debugging](../debug/endpoint_and_network_debugging.md) |
