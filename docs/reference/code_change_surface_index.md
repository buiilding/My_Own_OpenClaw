...
| Packaged app, sidecar runtime, reinstall, or platform permission behavior changes | Electron packaging, sidecar bundling, platform adapters | `frontend`, `frontend/src/main/platform`, `frontend/src/main/python`, `scripts`, build config | Frontend package smoke checks, sidecar tests, platform-specific manual checks | [Install Hub](../install/README.md), [Platform Change Workflow](../platforms/platform_change_workflow.md), [Platform Validation Matrix](../platforms/platform_validation_matrix.md), [Packaging Runtime Matrix](../platforms/packaging_runtime_matrix.md), [Packaging and Release Commands](../cli/packaging_and_release_commands.md) |
