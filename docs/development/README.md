...
| Electron main | windows, overlays, IPC handlers, SDK-runtime adapter, sidecar process lifecycle, permissions, packaged runtime env | [Frontend Main Hub](../frontend/main/README.md), [Frontend Runtime Hub](../frontend/runtime/README.md) | focused frontend Jest tests under `tests/frontend`, `bin/windie test frontend` |
