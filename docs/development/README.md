...
| Electron main | windows, overlays, IPC handlers, backend websocket bridge, sidecar process lifecycle, permissions, packaged runtime env | [Frontend Main Hub](../frontend/main/README.md), [Frontend Runtime Hub](../frontend/runtime/README.md) | focused frontend Jest tests under `tests/frontend`, `cd frontend && npm run test:ci` |
