...
- SDK/main tool routing behavior is covered by `tests/frontend/WindieSdkClient.test.ts`, `tests/frontend/AgentSdkConversationRuntime.test.ts`, and SDK tool-output tests.
