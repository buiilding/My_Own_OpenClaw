...
| --- | --- | --- | --- |
| Visible chat row is missing or duplicated | SDK projection store plus renderer display handlers | `packages/windie-sdk-js/src/projections`, `packages/windie-sdk-js/src/runtime/WindieDesktopAgent.ts`, chat stream handlers | SDK/main projection tests, `ChatStream*.test.ts` |
