...
| --- | --- | --- | --- |
| Visible chat row is missing or duplicated | SDK projection store plus renderer display handlers | `packages/windie-sdk-js/src/projections`, `frontend/src/main/windie_agent_host.cjs`, chat stream handlers | SDK/main projection tests, `ChatStream*.test.ts` |
