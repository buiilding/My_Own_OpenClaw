...
- [Backend Inventory Protocols Hub](inventory/protocols/README.md)
...
- [Content Converter Parsing and Multi-Image Preservation Reference](core/messages/content_converter_parsing_first_image_selection_and_type_alias_export_contract_reference.md)
- [Core Cache Docs Hub](core/cache/README.md)
- [Cache Store TTL, LRU, and Stats Contract Reference](core/cache/cache_store_ttl_lru_stats_contract_reference.md)
- [Cache Manager Namespace Keying and Cache Entry Singleton Reference](core/cache/cache_manager_namespace_keying_cache_entry_singleton_reference.md)
...
- [WebSocket Route Package Split Reference](api/websocket/websocket_route_package_split_reference.md)
...
- [Error Formatter Guard and Schema-Mapping Reference](api/processing/formatters/messages/error_formatter_guard_and_schema_mapping_reference.md)
...
- [Backend-Local Runtime Browser Schema Parity and Validation Boundary Reference](tools/browser/schema/backend_local_runtime_browser_schema_parity_and_validation_boundary_reference.md)
...
- [Tool Security Policy Reference](tools/tool_security_policy_and_executor_reference.md)
- [Policy Permissions, Audit Sanitization, and Removed Executor Registry Reference](tools/security/policy_permissions_audit_and_executor_registry_reference.md)
- [Tool Result Ingress and Storage Reference](tools/tool_result_ingress_and_storage_reference.md)
- [Tool Sender Local-Runtime Dispatch and Synthetic Error Result Reference](tools/execution/tool_sender_local_runtime_dispatch_and_synthetic_error_result_reference.md)
...
- [Package Runner and Main Module Uvicorn Bootstrap Contract Reference](simulation/entrypoints/package_runner_and_main_module_uvicorn_bootstrap_contract_reference.md)
