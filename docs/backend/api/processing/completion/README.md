---
summary: "Backend API processing completion docs sub-hub for query-execution helper contracts, compatibility event extraction, and completion backfill emission rules."
read_when:
...
- [Query Execution Helper Contracts and Compatibility Event Extraction Reference](query_execution_helper_contracts_and_compatibility_event_extraction_reference.md)
