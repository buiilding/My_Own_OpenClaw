...
| screenshot visibility bridge | `tests/frontend/LocalBackendBridgeWindowVisibility.test.cjs` | `tests/sidecar/test_screenshot_tool.py` | Use when screenshots include WindieOS surfaces or capture bounds are wrong. |
