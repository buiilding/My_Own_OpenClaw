...
| active-window context label | `docs/frontend/main/context_label_overlay_and_active_window_runtime_reference.md`, `frontend/src/main/surfaces/window_visibility_runtime.cjs` |
