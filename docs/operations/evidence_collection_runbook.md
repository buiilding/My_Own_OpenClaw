...
| Verbose sidecar stderr forwarding | `WINDIE_VERBOSE_SIDECAR_STDERR=1` |
...
| Query streams but local tool fails | Electron bridge or sidecar | [Sidecar Tool Change Workflow](../frontend/sidecar_tool_change_workflow.md) |
...
| Memory search missing old chat | Sidecar local memory/search | [Memory Change Workflow](../memory/memory_change_workflow.md) |
