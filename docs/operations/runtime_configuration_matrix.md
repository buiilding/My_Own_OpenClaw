...
| `WINDIE_VERBOSE_SIDECAR_STDERR` | Electron main env | Forwards all sidecar daemon stderr when `1`; default is severity-filtered | `frontend/src/main/sidecar/local_runtime_launch_options.cjs`, `frontend/src/main/sidecar/local_runtime_utils.cjs` |
