...
| --- | --- |
| Endpoint resolver | frontend endpoint tests, sidecar env propagation tests, `./bin/docs-list` |
...
| Runtime docs only | `./bin/docs-list`, markdown link check, `git diff --check` |
