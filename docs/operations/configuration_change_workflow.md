...
| local-runtime implementation variable changed | SDK local-runtime launch env and Python sidecar config reader | `frontend/src/main/sidecar/local_runtime_launch_options.cjs`, `frontend/src/main/python/core`, `frontend/src/main/python/tools` | [Sidecar Runtime Packaging](sidecar_runtime_packaging.md), [Local Tool Channels](../channels/sidecar_and_tool_channels.md) | `tests/sidecar/test_backend_config.py`, focused Python sidecar tool tests |
