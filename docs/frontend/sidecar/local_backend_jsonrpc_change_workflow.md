...
| Change `execute_tool` behavior | execute-tool runtime plus sidecar tool registry | `frontend/src/main/local_backend_bridge_execute_tool_runtime.cjs`, `frontend/src/main/python/tools/registry.py`, specific tool module | frontend tool execution tests, sidecar tool tests |
