---
summary: "Frontend sidecar browser_use docs sub-hub for vendored package bootstrap, lazy import machinery, config/env resolution, logging setup, optional observability hooks, and utility runtime helpers."
read_when:
  - When updating vendored `tools/browser/browser_use/*` package internals or import behavior.
  - When debugging browser_use logging setup, config path/env resolution, or optional lmnr observability behavior.
