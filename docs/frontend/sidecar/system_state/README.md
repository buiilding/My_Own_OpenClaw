---
summary: "Local-runtime system-state docs hub for field collection semantics, platform adapters, and renderer/main JSON-RPC consumption paths backed by Python sidecar implementations."
read_when:
