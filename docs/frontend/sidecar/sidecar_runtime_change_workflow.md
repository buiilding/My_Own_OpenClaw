...
- If renderer code will call it, add the IPC channel to `frontend/src/shared/ipcChannels.json` and map it in `frontend/src/main/sidecar/local_backend_bridge_rpc_mappers.cjs`.
