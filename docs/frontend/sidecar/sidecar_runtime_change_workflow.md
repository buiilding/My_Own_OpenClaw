...
| Browser launch, session, action, extraction, snapshot, file, or role ref behavior changes | Local-runtime browser implementation | `frontend/src/main/python/tools/browser/*`, `frontend/src/main/python/windie_shared/browser_contract*` | `tests/sidecar/test_browser_registry.py`, `tests/sidecar/tools/test_browser_*.py` | [Sidecar Browser Hub](browser/README.md), [Browser Automation Stack](browser_automation_stack.md) |
