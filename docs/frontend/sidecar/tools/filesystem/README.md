---
summary: "Local-runtime filesystem tools docs sub-hub for read-file pagination/binary guards and replace engine matching/atomic write semantics backed by Python sidecar implementations."
read_when:
