...
| Local runtime bridge | `cd frontend && npm run test -- LocalBackendBridge LocalRuntimeSupervisor` plus focused sidecar JSON-RPC tests when Python payloads change |
