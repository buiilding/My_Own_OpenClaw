...
| Local tool execution, memory, transcript storage | `frontend/src/main/sidecar/local_runtime_bridge.cjs`, `frontend/src/main/sidecar/local_backend_bridge_rpc_mappers.cjs`, `frontend/src/main/sidecar/local_backend_bridge_execute_tool_runtime.cjs` | tool execution service, transcript writer, memory panels | `tests/frontend/LocalBackendBridge*.test.cjs`, `tests/sidecar/test_json_rpc_protocol.py`, related sidecar tests |
