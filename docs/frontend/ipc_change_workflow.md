...
| Bad sidecar payload | Inspect `local_runtime_rpc_mappers.cjs`, method names, mapped keys, and sidecar handler params. | [Local Backend JSON-RPC Change Workflow](sidecar/local_backend_jsonrpc_change_workflow.md) |
