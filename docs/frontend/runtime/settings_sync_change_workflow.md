...
| sidecar env should change from a setting | SDK local-runtime launch options, not renderer storage alone | `frontend/src/main/sidecar/sdk_sidecar_launch_options.cjs`, `frontend/src/main/python/core`, `frontend/src/main/python/tools` | [Configuration Change Workflow](../../operations/configuration_change_workflow.md) | focused sidecar tests and launch/runtime checks |
