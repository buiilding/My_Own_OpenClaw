...
- Linux capture collapse includes a bounded `hide-chatbox -> settle -> screenshot` wait so compositor lag does not leave the pill visible inside captured screenshots
