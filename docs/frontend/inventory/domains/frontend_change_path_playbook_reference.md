...
2. Update the SDK local-runtime client in `packages/windie-sdk-js/src/runtime/WindieDesktopAgent.ts` or `packages/windie-sdk-js/src/runtime/LocalSidecarRuntime.ts`.
