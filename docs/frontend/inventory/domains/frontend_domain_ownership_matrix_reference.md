...
| Main SDK desktop agent + settings gate | `frontend/src/main/ipc.cjs`, `packages/windie-sdk-js/src/runtime/WindieDesktopAgent.ts`, `main/ipc_runtime_helpers.cjs`, `main/ipc_renderer_windows.cjs`, `main/ipc_query_broadcast.cjs` | `main/backend_endpoints.cjs`, `main/ipc_query_events.cjs`, `main/query_payload_builder.cjs` | sidecar tool modules |
...
- `main/**` owns process lifecycle, OS windowing, SDK-runtime adaptation, sidecar subprocess lifecycle.
