...
| Local sidecar daemon lifecycle | `packages/windie-sdk-js/src/runtime/LocalRuntime.ts`, `frontend/src/main/sidecar/local_runtime_launch_options.cjs`, `frontend/src/main/sidecar/local_backend_bridge.cjs`, `frontend/src/main/sidecar/local_backend_supervisor.cjs`, `frontend/src/main/app/runtime_paths.cjs` | SDK-owned daemon startup/reuse, desktop launch options, readiness/status snapshots, and shutdown. |
