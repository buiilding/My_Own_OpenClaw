...
| Sidecar RPC request mapping | `frontend/src/main/sidecar/local_runtime_bridge.cjs`, `frontend/src/main/sidecar/local_runtime_rpc_mappers.cjs`, `frontend/src/main/sidecar/local_runtime_utils.cjs`, `frontend/src/main/sidecar/local_runtime_window_visibility.cjs` | SDK local runtime RPC routing, payload mapping, and host window/screenshot wrapper behavior. |
