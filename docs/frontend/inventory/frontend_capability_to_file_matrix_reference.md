...
| Local sidecar process lifecycle | `frontend/src/main/local_backend_bridge.cjs`, `frontend/src/main/local_backend_launch_plan.cjs`, `frontend/src/main/local_backend_process_events.cjs`, `frontend/src/main/local_backend_stop_controller.cjs`, `frontend/src/main/local_backend_readiness_runtime.cjs`, `frontend/src/main/runtime_paths.cjs` | Bridge composition, launch planning, readiness, active-process exit/error policy, and shutdown/force-kill behavior. |
| Sidecar RPC request mapping | `frontend/src/main/local_backend_bridge_request_transport.cjs`, `frontend/src/main/local_backend_bridge_rpc_transport.cjs`, `frontend/src/main/local_backend_bridge_rpc_mappers.cjs`, `frontend/src/main/local_backend_bridge_utils.cjs`, `frontend/src/main/local_backend_bridge_window_visibility.cjs` | JSON-RPC transport selection, request correlation, timeout, payload mapping, and window/screenshot visibility runtime wrapper behavior. |
