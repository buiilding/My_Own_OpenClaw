...
| Overlay visibility and side-channel signaling | `frontend/src/main/overlay_signal_runtime.cjs`, `frontend/src/main/surfaces/response_overlay_phase_handler.cjs` | Broadcasts overlay visibility + wakeword toggle/STT triggers. |
