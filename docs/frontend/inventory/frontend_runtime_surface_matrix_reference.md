...
| Main process sidecar bridge | `frontend/src/main/sidecar/local_backend_bridge.cjs`, `frontend/src/main/sidecar/local_runtime_launch_options.cjs`, `frontend/src/main/sidecar/local_backend_supervisor.cjs`, `packages/windie-sdk-js/src/runtime/LocalRuntime.ts` | SDK-owned daemon launch/reuse, renderer-visible status, and Electron host helper routing | Tool/system/memory responses |
