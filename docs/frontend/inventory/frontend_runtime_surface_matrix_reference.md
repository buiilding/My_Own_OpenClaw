...
| --- | --- | --- | --- |
| Electron app runtime | `frontend/src/main/index.cjs`, `frontend/src/main/surfaces/main_window_runtime.cjs`, `frontend/src/main/main_process_lifecycle_runtime.cjs` | Window/tray setup, lifecycle listeners, bridge initializers | Renderer windows + process shutdown |
...
| Main process sidecar bridge | `frontend/src/main/sidecar/local_backend_bridge.cjs`, `frontend/src/main/sidecar/sdk_sidecar_launch_options.cjs`, `frontend/src/main/sidecar/local_backend_supervisor.cjs`, `packages/windie-sdk-js/src/runtime/LocalSidecarRuntime.ts` | SDK-owned daemon launch/reuse, renderer-visible status, and Electron host helper routing | Tool/system/memory responses |
...
| Main relay and gating | `main/ipc.cjs`, `packages/windie-sdk-js/src/runtime/WindieClient.ts`, `packages/windie-sdk-js/src/runtime/ConversationRuntime.ts` |
