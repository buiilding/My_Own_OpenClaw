...
- onboarding completion persists `desktop-agent-permission-onboarding` (`manifest_version`, `completed`, `completed_at`) then routes to dashboard shell; legacy `windieos-permission-onboarding` state remains read-compatible
