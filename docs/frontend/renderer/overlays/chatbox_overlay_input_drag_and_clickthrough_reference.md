...
- compact/default and multiline states keep one shared control row aligned off the pill bottom edge, avoiding layout drift while preserving the original compact visual baseline.
