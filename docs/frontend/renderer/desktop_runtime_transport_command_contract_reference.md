...
mode, entrypoint `view` routing, and initial wakeword suppression seeding.
`main.jsx`, `App.jsx`, and `AppConfigProvider` consume this facade instead of
reading raw `window.location.search` or importing the VM-mode helper directly.
