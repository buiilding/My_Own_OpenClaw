...
| Replay, transcript load, pending queue, or stored message shape changes | Transcript infrastructure and replay projection | `infrastructure/transcript/*`, `features/chat/utils/conversationReplayToolMessages.js` | `tests/frontend/Transcript*.test.*`, `tests/frontend/StoredTranscript*.test.js`, `tests/frontend/ConversationReplayState.test.ts` | [Renderer Transcript Hub](transcript/README.md), [Transcript Session and Rehydrate](transcript_session_and_rehydrate_reference.md) |
