...
| Local tool result never returns, returns twice, or targets stale turn | SDK desktop agent, sidecar bridge, and renderer display projection | `frontend/src/main/windie_agent_host.cjs`, `packages/windie-sdk-js/src/tools/ToolExecutionCoordinator.ts`, `features/chat/hooks/chatStream/useChatStreamToolHandlers.ts` | `tests/frontend/WindieAgentHost.test.cjs`, `tests/frontend/WindieSdkDesktopAgent.test.ts`, `tests/frontend/ChatStreamToolHandlers.test.ts` | [Tool Execution Lifecycle](../../tools/tool_execution_lifecycle.md), [Sidecar Tool Change Workflow](../sidecar_tool_change_workflow.md) |
