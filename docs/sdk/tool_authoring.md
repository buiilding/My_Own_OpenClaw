...
WindieOS backend SDK tool authoring is separate from sidecar local tool implementation. Use SDK tools for backend-owned capabilities; use sidecar tools for local machine control.
