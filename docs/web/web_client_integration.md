...
| --- | --- | --- | --- |
| TypeScript hosted client | `frontend/src/renderer/infrastructure/api/windieSdkClient.ts` | artifacts, SDK routes, websocket query transport | local sidecar tools or Electron-only state |
...
| VM worker runtime | `frontend/src/main/vm_worker_runtime.cjs` | `/api/runs/*` assignment/control and normal websocket dispatch | normal desktop user query routing |
