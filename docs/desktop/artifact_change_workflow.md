...
| replayed chat image is missing | renderer transcript/replay and message image resolver | `frontend/src/renderer/infrastructure/transcript`, `frontend/src/renderer/app/runtime/desktopMessageScreenshotRuntime.js`, `frontend/src/renderer/app/runtime/desktopResolvedMessageScreenshotsRuntime.js`, SDK/local-runtime transcript store backed by local-runtime Python modules | [Memory Change Workflow](../memory/memory_change_workflow.md), [Transcript and Replay](../memory/transcript_and_replay.md) | frontend transcript/message screenshot tests, SDK/local-runtime transcript tests |
