...
```bash
./scripts/test-backend tests/backend/test_models_config.py tests/backend/test_model_service.py -q
./scripts/test-backend tests/backend/test_provider_factory_helpers.py tests/backend/test_llm_provider_base.py -q
```
