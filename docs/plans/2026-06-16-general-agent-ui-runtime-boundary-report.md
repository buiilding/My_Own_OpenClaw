...
- Latest completed slice: Electron main local-runtime launch options keep
  daemon env-key normalization private to `local_runtime_launch_options.cjs`,
  while tests and callers validate behavior through
