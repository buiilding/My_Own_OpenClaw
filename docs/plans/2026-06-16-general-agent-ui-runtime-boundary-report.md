...
- Latest completed slice: Electron main-process trace routing keeps trace input
  normalization private to `ipc_main_process_trace_runtime.cjs`, with
  string/duration/data sanitization covered through
