...
- Latest completed slice: Electron main window platform policy keeps
  focused-window activation private to `window_platform_policy.cjs`, while
  visibility code consumes it through `createWindowPlatformPolicy(...)`.
