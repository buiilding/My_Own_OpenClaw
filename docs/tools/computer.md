...
- [Local Runtime Sidecar Mouse, Keyboard, Scroll, and Screenshot Runtime Reference](../frontend/sidecar/tools/computer/mouse_keyboard_scroll_and_screenshot_runtime_reference.md)
