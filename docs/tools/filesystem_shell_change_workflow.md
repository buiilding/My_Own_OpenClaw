...
| Tool is visible but never reaches the sidecar | SDK runtime tool router or Electron bridge | `frontend/src/main/ipc/ipc_sdk_tool_router.cjs`, `frontend/src/main/local_backend_bridge_execute_tool_runtime.cjs` | `tests/frontend/IpcSdkToolRouter.test.cjs`, bridge lifecycle/RPC tests |
