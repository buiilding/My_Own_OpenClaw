...
| SDK/main dispatch/result envelope | focused `cd frontend && npm run test -- WindieSdkClient AgentSdkConversationRuntime RendererToolResultBoundary ToolOutputContent` tests |
