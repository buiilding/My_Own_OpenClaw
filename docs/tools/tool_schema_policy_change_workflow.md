...
| Local runtime says tool not found or rejects executable args | Local-runtime registry/schema implementation | `frontend/src/main/python/tools/registry.py`, `frontend/src/main/python/tools/manifest.py`, `frontend/src/main/python/tools/**` | [Sidecar Tool Change Workflow](../frontend/sidecar_tool_change_workflow.md), [Local-Runtime Tool Catalog and Execution Model](../frontend/sidecar/tool_catalog_and_execution_model.md) | `tests/sidecar/test_tool_registry.py`, `tests/sidecar/test_tool_schemas.py`, tool-specific sidecar tests |
