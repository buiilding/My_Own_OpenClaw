...
| SDK/main drops fields, result ids, artifacts, screenshots, or bundle metadata | SDK conversation/tool runtime and SDK local-runtime bridge | `packages/windie-sdk-js/src/index.ts`, `packages/windie-sdk-js/src/runtime/AgentClient.ts`, `packages/windie-sdk-js/src/runtime/Agent.ts`, `packages/windie-sdk-js/src/runtime/ConversationRuntime.ts`, `packages/windie-sdk-js/src/runtime/LocalSidecarRuntime.ts`, `packages/windie-sdk-js/src/tools/ToolExecutionCoordinator.ts` | [Tool Execution Lifecycle](tool_execution_lifecycle.md), [Sidecar and Tool Channels](../channels/sidecar_and_tool_channels.md) | SDK conversation/tool-runtime tests and backend tool-result tests |
