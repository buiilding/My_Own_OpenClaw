...
| Client manifest agent definition | `frontend/src/main/sdk/agent_definition.cjs`, `frontend/src/main/extensions/tool_manifest.cjs`, `packages/windie-sdk-js/src/runtime/WindieAgent.ts` |
