...
| Python sidecar | Local JSON-RPC, shell/filesystem/computer/system tools, browser runtime, local memory, system state, wakeword service | `frontend/src/main/python` | [Frontend Sidecar Docs Hub](../frontend/sidecar/README.md), [Sidecar Runtime Change Workflow](../frontend/sidecar/sidecar_runtime_change_workflow.md), [Frontend Sidecar Tools Docs Hub](../frontend/sidecar/tools/README.md), [Sidecar Tool Change Workflow](../frontend/sidecar_tool_change_workflow.md) |
