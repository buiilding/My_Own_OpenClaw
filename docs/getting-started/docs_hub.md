...
| Renderer | Chat UI, dashboard, settings, permissions, voice UI, stream event consumption, tool runner, transcript queue | `frontend/src/renderer` | [Frontend Renderer Docs Hub](../frontend/renderer/README.md), [Dashboard Change Workflow](../frontend/renderer/dashboard/dashboard_change_workflow.md), [Renderer State Change Workflow](../frontend/renderer/renderer_state_change_workflow.md), [Frontend Inventory Domains Hub](../frontend/inventory/domains/README.md) |
