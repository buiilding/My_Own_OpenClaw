...
| Backend services | Artifacts, embeddings, semantic memory API, OCR, vision, token counting, TTS/wakeword audio services | `backend/src/services`, `backend/src/embeddings`, `backend/src/api/routes` | [Backend Services Docs Hub](../backend/services/README.md), [Backend Service Change Workflow](../backend/services/backend_service_change_workflow.md), [Backend Services Screen-Grounding Docs Hub](../backend/services/screen_grounding/README.md) |
