...
| Hosted SDK route | FastAPI SDK router + client wrappers | `backend/src/api/routes/sdk`, `frontend/src/renderer/infrastructure/api/agentSdkClient.ts`, `frontend/src/main/python/core/windie_sdk_client.py` | backend route tests, TS/Python SDK client tests |
