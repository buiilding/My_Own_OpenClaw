...
| [ADR 005: Frontend Tool Schema Source of Truth](005-frontend-tool-schema-source-of-truth.md) | proposed | Explore frontend/sidecar-authored executable tool manifests while preserving backend-owned model-facing policy and no runtime backend imports. |
