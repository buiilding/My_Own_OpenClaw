...
- [**Local Runtime Sidecar Memory Storage Docs Hub**](frontend/sidecar/memory/storage/README.md) - Sub-hub for local-runtime storage internals backed by Python sidecar modules: dual-db routing/search, chat-event storage, FAISS artifact cleanup, and schema/index/watermark persistence contracts
