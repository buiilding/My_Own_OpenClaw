...
- [**Frontend Context Label Overlay + Active-Window Runtime**](frontend/main/context_label_overlay_and_active_window_runtime_reference.md) - Removed renderer route status plus retained dormant main-process context-label helper wiring
