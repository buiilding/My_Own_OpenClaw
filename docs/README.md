...
- [**Frontend IPC + Sidecar Contract Touchpoints**](frontend/inventory/frontend_ipc_and_sidecar_contract_touchpoints_reference.md) - Renderer/main/local-runtime boundary map for IPC, sidecar JSON-RPC methods, and backend stream/tool payload integration points
