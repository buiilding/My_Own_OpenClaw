...
| Electron main process | Window lifecycle, overlay surfaces, websocket relay, local config, permission probes, sidecar process supervision, local JSON-RPC bridge | `frontend/src/main` |
