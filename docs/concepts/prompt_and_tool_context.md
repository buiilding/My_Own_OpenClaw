...
| backend event -> SDK/main execution | executable tool event payload | `backend/src/api/processing/formatters`, `packages/windie-sdk-js/src/tools`, `frontend/src/main/windie_agent_host.cjs` | Are model-facing args and executable args being confused? |
