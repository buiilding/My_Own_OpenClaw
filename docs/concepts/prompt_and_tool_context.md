...
| SDK/main -> sidecar | IPC/JSON-RPC executable params | `frontend/src/main/local_backend_bridge*.cjs`, `frontend/src/main/python/tools` | Is this the single JS/Python boundary mapper, or duplicated fallback logic? |
