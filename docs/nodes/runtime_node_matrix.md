...
| local-runtime JSON-RPC | SDK `LocalRuntime` with Electron host context | Python sidecar daemon | [Local Tool Channels](../channels/sidecar_and_tool_channels.md), [Local-Runtime JSON-RPC Protocol Reference](../frontend/sidecar/core/json_rpc_protocol_stdout_framing_and_shutdown_signal_runtime_reference.md) |
