...
| sidecar local runtime | SDK `LocalRuntime` with Electron host context | Python sidecar daemon | [Sidecar and Tool Channels](../channels/sidecar_and_tool_channels.md), [Sidecar JSON-RPC Protocol Reference](../frontend/sidecar/core/json_rpc_protocol_stdout_framing_and_shutdown_signal_runtime_reference.md) |
