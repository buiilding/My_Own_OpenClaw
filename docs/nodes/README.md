...
| Python sidecar node | local Python sidecar daemon managed by SDK local runtime | filesystem/shell/computer/browser tools, local memory, system state, JSON-RPC methods, SDK helper clients | [Desktop and Sidecar Node](desktop_and_sidecar_node.md), [Local Runtime Sidecar Docs Hub](../frontend/sidecar/README.md) |
