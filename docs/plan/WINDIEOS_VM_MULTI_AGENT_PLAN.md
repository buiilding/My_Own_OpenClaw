...
- `docs/FUTURE_PLAN.md` (Windie-owned machine strategy).
- `docs/DEPLOYMENT.md` (hosted disposable workspace track).
- `docs/MULTI_USER_RUNTIME_HARDENING.md` (identity/session safety).
- `docs/SECURITY_AND_COMPLIANCE.md` and `docs/BILLING_AND_USAGE.md`.
