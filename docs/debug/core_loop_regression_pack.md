...
| Response overlay native sizing is mode-guarded so late awaiting-typing reports cannot shrink a same-turn streaming response overlay back to the typing frame. | `OverlayResponseboxHandler.test.cjs` |
