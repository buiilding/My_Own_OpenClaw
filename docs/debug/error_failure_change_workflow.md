...
| Local backend JSON-RPC/process failure | Electron local backend bridge | `frontend/src/main/sidecar/local_runtime_bridge.cjs`, `frontend/src/main/sidecar/local_runtime_utils.cjs`, sidecar process launch helpers | `tests/frontend/LocalRuntimeBridge*.test.cjs` | [Sidecar Runtime Change Workflow](../frontend/sidecar/sidecar_runtime_change_workflow.md) |
