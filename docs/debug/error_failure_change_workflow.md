...
| Renderer tool-runner failure display/persistence | Renderer chat/tool execution | `frontend/src/renderer/infrastructure/services/toolExecution/**`, `frontend/src/renderer/features/chat/utils/toolRunner/**` | `tests/frontend/ToolRunnerFailureContracts.test.ts`, `ToolExecutionResultDispatch.test.ts` | [Tool Execution Lifecycle](../tools/tool_execution_lifecycle.md) |
