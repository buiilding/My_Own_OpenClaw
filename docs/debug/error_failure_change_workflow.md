...
| SDK/main tool-dispatch failure and display projection | SDK desktop agent plus renderer projection | `packages/windie-sdk-js/src/tools`, `packages/windie-sdk-js/src/runtime/WindieDesktopAgent.ts`, `frontend/src/renderer/features/chat/hooks/chatStream/useChatStreamToolHandlers.ts` | SDK desktop-agent tests, `ChatStreamToolHandlers.test.ts` | [Tool Execution Lifecycle](../tools/tool_execution_lifecycle.md) |
