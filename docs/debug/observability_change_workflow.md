...
| tool execution or tool screenshot debug output | SDK desktop-agent tool routing and sidecar capture | `packages/windie-sdk-js/src/tools`, `packages/windie-sdk-js/src/runtime/WindieDesktopAgent.ts`, `frontend/src/main/local_backend_bridge_screenshot_attachment.cjs` | [Tool Execution Lifecycle](../tools/tool_execution_lifecycle.md), [Runtime Traces](runtime_traces.md) | SDK desktop-agent tests, sidecar screenshot tests |
