...
| tool execution or tool screenshot debug output | SDK tool routing and sidecar capture | `packages/windie-sdk-js/src/tools/ToolExecutionCoordinator.ts`, `packages/windie-sdk-js/src/runtime/Agent.ts`, `frontend/src/main/sidecar/local_backend_bridge_screenshot_attachment.cjs` | [Tool Execution Lifecycle](../tools/tool_execution_lifecycle.md), [Runtime Traces](runtime_traces.md) | SDK tool/runtime tests, sidecar screenshot tests |
