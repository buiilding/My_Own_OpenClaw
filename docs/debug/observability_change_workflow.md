...
| tool execution or tool screenshot debug output | SDK desktop-agent tool routing and sidecar capture | `packages/windie-sdk-js/src/tools`, `frontend/src/main/windie_agent_host.cjs`, `frontend/src/main/local_backend_bridge_screenshot_attachment.cjs` | [Tool Execution Lifecycle](../tools/tool_execution_lifecycle.md), [Runtime Traces](runtime_traces.md) | SDK desktop-agent tests, sidecar screenshot tests |
