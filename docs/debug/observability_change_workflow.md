...
| tool execution or tool screenshot debug output | SDK/main tool routing and sidecar capture | `packages/windie-sdk-js/src/tools`, `frontend/src/main/ipc/ipc_sdk_tool_router.cjs`, `frontend/src/main/local_backend_bridge_screenshot_attachment.cjs` | [Tool Execution Lifecycle](../tools/tool_execution_lifecycle.md), [Runtime Traces](runtime_traces.md) | SDK/main tool-router tests, sidecar screenshot tests |
