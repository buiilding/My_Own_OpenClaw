...
| Artifacts/screenshots | `bin/windie test frontend -- ArtifactUploader.test.ts IpcArtifactFetch.test.cjs QueryScreenshotPipeline.test.ts ChatMessageSender.test.tsx WindieSdkConversationRuntime.test.ts LocalBackendBridgeExtensionRuntime.test.cjs` |
