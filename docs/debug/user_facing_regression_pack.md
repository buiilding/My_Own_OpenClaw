...
| --- | --- | --- |
| Core loop UI | `<windie> test core-loop` | Chat pill, dashboard, response overlay, renderer-owned visible turn lifecycle, screenshot metadata display load, SDK projection, typed user/tool visual attachments, conversation runtime, IPC, replay, stop, tool-row, and surface-lease invariants. |
