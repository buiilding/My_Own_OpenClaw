...
| Main phase IPC | `frontend/src/main/surfaces/response_overlay_phase_handler.cjs`, `frontend/src/main/overlay_phase_ipc_runtime.cjs` | Phase writes and renderer notification. |
| Main window policy | `frontend/src/main/surfaces/surface_runtime.cjs`, `frontend/src/main/window_visibility_runtime.cjs`, `frontend/src/main/surfaces/display_affinity_runtime.cjs` | Visibility, capture, content protection, and display affinity. |
