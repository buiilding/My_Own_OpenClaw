...
| Main bridge request mapping | `frontend/src/main/sidecar/local_runtime_execute_tool_runtime.cjs`, `frontend/src/main/sidecar/local_runtime_rpc_mappers.cjs`, `frontend/src/main/sidecar/local_runtime_tool_args.cjs` |
