...
| Session metadata | `router.py` | Stores frontend OS and capability overrides on session manager when present. | Wrong tool visibility or OS policy can start here. |
