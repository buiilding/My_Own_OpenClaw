...
| Electron handshake or reconnect drift | SDK desktop-agent host | `frontend/src/main/windie_agent_host.cjs`, `frontend/src/main/ipc.cjs`, frontend endpoint/auth code | frontend websocket/main IPC tests |
