...
| Electron handshake or reconnect drift | Electron main websocket relay | `frontend/src/main/ipc.cjs`, frontend endpoint/auth code | frontend websocket/main IPC tests |
