...
| Electron handshake or reconnect drift | SDK runtime adapter | `frontend/src/main/windie_sdk_runtime.cjs`, `frontend/src/main/ipc.cjs`, frontend endpoint/auth code | frontend websocket/main IPC tests |
