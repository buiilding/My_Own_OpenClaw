...
| renderer loads but sidecar tools fail | Electron main sidecar bridge | sidecar readiness logs, `frontend/src/main/sidecar/local_runtime_bridge.cjs`, `WINDIE_SIDECAR_LOG_LEVEL=DEBUG` |
