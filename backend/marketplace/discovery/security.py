...
dangerous code patterns before they can be loaded.
"""
...
# Risky patterns that indicate potentially unsafe code
RISKY_PATTERNS = [
...
ALLOWED_IMPORTS: Set[str] = {
    ...
    "backend.utils.schema_generator",
}

# Backend utils are allowed with wildcard
BACKEND_UTILS_PREFIX = "backend.utils."
