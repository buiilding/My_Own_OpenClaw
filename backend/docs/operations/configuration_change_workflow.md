...
| local-runtime implementation variable changed | SDK local-runtime launch env and local-runtime Python config reader | `frontend/src/main/sidecar/local_runtime_launch_options.cjs`, `frontend/src/main/python/core`, `frontend/src/main/python/tools` | [Bundled Python Runtime Packaging](local_runtime_packaging.md), [Local Tool Channels](../../../frontend/docs/channels/local_tool_channels.md) | `tests/sidecar/test_backend_config.py`, focused local-runtime Python tool tests |
...
- `docs/install/backend_endpoint_setup.md`
