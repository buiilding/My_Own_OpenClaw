---
summary: "Backend screen-grounding OCR helper docs sub-hub for CUDA-error classification, screenshot payload decoding, and OCR field normalization contracts."
read_when:
  - When changing `backend/src/services/ocr/helpers.py` helper behavior.
  - When debugging OCR fallback misclassification, screenshot base64 decode failures, or mixed OCR SDK payload normalization issues.
