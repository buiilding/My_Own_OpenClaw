...
- this remote bridge is direct-name based; the live backend catalog and local-runtime exposed-tool set backed by local-runtime Python modules both use concrete tool names such as `mouse_control` and `run_shell_command`
