...
| SDK tool/context/sub-agent helpers | `backend/src/sdk/{tool,context}.py`, `backend/src/core/services/agent_factory.py` | Tool authoring and constrained sub-session helper APIs. |
