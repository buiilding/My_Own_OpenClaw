...
OPENAI_PRESETS: List[Dict[str, Any]] = [
    ...
    _variant(runtime_model_id="gpt-5.3-codex", display_name="GPT-5.3 Codex Fast", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.3-codex", display_name="GPT-5.3 Codex High", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.3-codex", display_name="GPT-5.3 Codex High Fast", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.3-codex", display_name="GPT-5.3 Codex Extra High", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.3-codex", display_name="GPT-5.3 Codex Extra High Fast", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.3-codex", display_name="GPT-5.3 Codex Spark Low", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.3-codex", display_name="GPT-5.3 Codex Spark", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.3-codex", display_name="GPT-5.3 Codex Spark High", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.3-codex", display_name="GPT-5.3 Codex Spark Extra High", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.2", display_name="GPT-5.2 Low", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.2", display_name="GPT-5.2 Low Fast", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.2", display_name="GPT-5.2", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.2", display_name="GPT-5.2 Fast", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.2", display_name="GPT-5.2 High", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.2", display_name="GPT-5.2 High Fast", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.2", display_name="GPT-5.2 Extra High", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.2", display_name="GPT-5.2 Extra High Fast", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.2-codex", display_name="GPT-5.2 Codex Low", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.2-codex", display_name="GPT-5.2 Codex Low Fast", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.2-codex", display_name="GPT-5.2 Codex", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.2-codex", display_name="GPT-5.2 Codex Fast", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.2-codex", display_name="GPT-5.2 Codex High", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.2-codex", display_name="GPT-5.2 Codex High Fast", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.2-codex", display_name="GPT-5.2 Codex Extra High", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.2-codex", display_name="GPT-5.2 Codex Extra High Fast", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.1-codex-max", display_name="GPT-5.1 Codex Max Low", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.1-codex-max", display_name="GPT-5.1 Codex Max Low Fast", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.1-codex-max", display_name="GPT-5.1 Codex Max", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.1-codex-max", display_name="GPT-5.1 Codex Max Medium Fast", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.1-codex-max", display_name="GPT-5.1 Codex Max High", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.1-codex-max", display_name="GPT-5.1 Codex Max High Fast", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.1-codex-max", display_name="GPT-5.1 Codex Max Extra High", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.1-codex-max", display_name="GPT-5.1 Codex Max Extra High Fast", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.1", display_name="GPT-5.1 High", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.1-codex-mini", display_name="GPT-5.1 Codex Mini Low", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.1-codex-mini", display_name="GPT-5.1 Codex Mini", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5.1-codex-mini", display_name="GPT-5.1 Codex Mini High", supports_thinking=True, supports_thinking_text_stream=False),
    _variant(runtime_model_id="gpt-5-mini", display_name="GPT-5 Mini", supports_thinking=True, supports_thinking_text_stream=False),
]
