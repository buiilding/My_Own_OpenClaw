...
class ConfigManager:
    ...
    def load_config(self) -> AppConfig:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.error(
                    "Failed to load config from Python file: %s", e, exc_info=True
                )
    ...
    def update_config(self, new_config: AppConfig) -> AppConfig:
        ...
        logger.info(
            "Configuration updated in memory (not persisted - edit app_config.py to make permanent changes)"
        )
    ...
    def reload_config(self) -> AppConfig:
        ...
        try:
            ...
            logger.error(
                "Failed to reload config from Python file: %s", e, exc_info=True
            )
