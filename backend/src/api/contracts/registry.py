...
OUTGOING_SCHEMA_CONTRACTS: tuple[MessageContract, ...] = (
    ...
    MessageContract(OutgoingMessageType.SETTINGS_LOADED, SettingsLoadedMessage),
    MessageContract(OutgoingMessageType.STOP_QUERY_ACK, StopQueryAckMessage),
    MessageContract(OutgoingMessageType.SETTINGS_UPDATED, SettingsUpdatedMessage),
    MessageContract(OutgoingMessageType.MODELS_LISTED, ModelsListedMessage),
