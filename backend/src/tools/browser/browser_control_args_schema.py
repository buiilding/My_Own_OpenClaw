"""Canonical grouped browser tool contract for backend and sidecar."""
...
def _clean_action_schema(model: type[BrowserActionArgsBase]) -> dict[str, Any]:
    ...
    resolved_schema = Tool._resolve_local_defs(raw_schema)
    cleaned_schema = Tool._clean_schema(resolved_schema)
