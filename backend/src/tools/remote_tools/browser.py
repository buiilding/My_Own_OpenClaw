...
- compatibility aliases (legacy, deprecated): type->input, press->send_keys, switch_tab->switch
- removed legacy aliases: `open` (use `navigate`) and `act` (use canonical actions directly)
