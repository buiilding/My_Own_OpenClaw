...
export const windieDesktopSkin = Object.freeze({
  ...
  settings: Object.freeze({
    agent: Object.freeze({
      ...
      localTools: Object.freeze({
        ...
        description: 'These groups control which local tools are included in the client tool manifest.',
        stateOptions: Object.freeze([
          Object.freeze({ value: 'allowed', label: 'Allowed' }),
        ...
        groups: Object.freeze([
          Object.freeze({
            id: 'screen',
            label: 'Screen',
            tools: Object.freeze(['screenshot']),
          }),
          Object.freeze({
            id: 'files',
            label: 'Files',
            tools: Object.freeze(['read_file', 'replace']),
          }),
          Object.freeze({
            id: 'browser',
            label: 'Browser',
            tools: Object.freeze(['browser']),
          }),
          Object.freeze({
            id: 'shell',
            label: 'Shell',
            tools: Object.freeze(['run_shell_command', 'process']),
          }),
          Object.freeze({
            id: 'mouse-keyboard',
  ...
  memoryPanel: Object.freeze({
    ...
    retrievalToggleLabel: 'Memory configuration',
    retrievalStateLabel: Object.freeze({
      enabled: 'Allowed',
      disabled: 'Disabled',
    }),
    retrievalStateOptions: Object.freeze([
      Object.freeze({ value: 'allowed', label: 'Allowed' }),
      Object.freeze({ value: 'disabled', label: 'Disabled' }),
    ]),
