...
async def execute_screenshot(args):
    result = await screenshot_tool.execute_screenshot_tool(args)
...
@pytest.mark.asyncio
async def test_execute_screenshot_success_with_display_bounds(monkeypatch):
    calls = []
...
@pytest.mark.asyncio
async def test_execute_screenshot_crops_full_virtual_desktop_to_target_monitor(
    monkeypatch,
):
    calls = []
...
@pytest.mark.asyncio
async def test_execute_screenshot_scales_full_virtual_desktop_crop_to_image_pixels(
    monkeypatch,
):
    calls = []
...
@pytest.mark.asyncio
async def test_execute_screenshot_on_macos_uses_direct_region_for_monitor_bounds(
    monkeypatch,
):
    calls = []
...
@pytest.mark.asyncio
async def test_execute_screenshot_resizes_full_desktop_to_logical_coordinates(
    monkeypatch,
):
    calls = []
...
@pytest.mark.asyncio
async def test_execute_screenshot_resizes_region_to_display_bounds(monkeypatch):
    calls = []
...
@pytest.mark.asyncio
async def test_execute_screenshot_keeps_identity_sized_capture(monkeypatch):
    calls = []
...
@pytest.mark.asyncio
async def test_execute_screenshot_import_error_returns_failure(monkeypatch):
...
@pytest.mark.asyncio
async def test_execute_screenshot_runtime_error_returns_failure(monkeypatch):
...
@pytest.mark.asyncio
async def test_execute_screenshot_windows_uses_native_cursor_capture_path(monkeypatch):
