...
Start with [Local Runtime Process Lifecycle Workflow](../frontend/main/local_runtime/process_lifecycle_change_workflow.md), [Local Runtime JSON-RPC Change Workflow](../frontend/local_runtime_python/local_runtime_jsonrpc_change_workflow.md), and [Local Runtime Python Implementation Docs Hub](../frontend/local_runtime_python/README.md).
