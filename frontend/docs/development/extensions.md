...
cd ..
./scripts/python-in-env local-runtime python -m pytest frontend/tests/sidecar/test_tool_manifest.py frontend/tests/sidecar/test_sidecar_daemon.py frontend/tests/sidecar/test_repo_agent_example.py -q
```
