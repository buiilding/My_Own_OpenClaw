...
| SDK runtime invokes tool but local runtime says missing tool | Local-runtime registry/exposed-name parity backed by local-runtime Python implementation | [Tool Catalog Matrix](tool_catalog_matrix.md), [Local-Runtime Registry and Result Contract](../frontend/local_runtime_python/tools/registry/tool_registry_exposed_schema_and_result_contract_reference.md) |
