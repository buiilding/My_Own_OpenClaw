...
| screenshot visibility bridge | `tests/frontend/LocalRuntimeWindowVisibility.test.cjs` | `frontend/tests/sidecar/test_screenshot_tool.py` | Use when screenshots include desktop app surfaces or capture bounds are wrong. |
...
| display affinity and multi-monitor targeting | `tests/frontend/DisplayAffinityRuntime.test.cjs`, `tests/frontend/DisplayQueryHandler.test.cjs` | `frontend/tests/sidecar/test_screenshot_tool.py` | Include manual multi-monitor capture check if the bug was monitor-specific. |
...
| local-runtime Python mouse control | not applicable unless renderer tool dispatch changed | `frontend/tests/sidecar/test_mouse_tool.py` | Manual pointer movement may be required for OS-level confidence. |
| local-runtime Python keyboard control | not applicable unless renderer tool dispatch changed | `frontend/tests/sidecar/test_keyboard_tool.py` | Validate permission handling before changing key synthesis. |
| local-runtime Python scroll control | not applicable unless renderer tool dispatch changed | `frontend/tests/sidecar/test_scroll_tool.py`, `frontend/tests/sidecar/test_scroll_config.py` | Include app-focus manual check if scrolling target changed. |
| local-runtime Python window manager | not applicable unless UI consumes active-window labels | `frontend/tests/sidecar/test_macos_window_manager.py`, `frontend/tests/sidecar/test_windows_window_manager.py`, `frontend/tests/sidecar/test_linux_window_manager.py`, `frontend/tests/sidecar/test_platform_module_selection.py` | Keep platform module selection deterministic. |
