...
| local-runtime implementation | `WINDIE_PYTHON_PATH`, `WINDIE_LOCAL_RUNTIME_LOG_LEVEL`, `AGENT_LOCAL_RUNTIME_LOG_LEVEL`, `WINDIE_VERBOSE_LOCAL_RUNTIME_STDERR`, `WINDIE_USER_DATA_DIR`, `AGENT_USER_DATA_DIR`, `WINDIE_APP_DIAGNOSTICS_DB`, `AGENT_APP_DIAGNOSTICS_DB`, `WINDIE_TEST_PLATFORM`, `AGENT_TEST_PLATFORM` |
