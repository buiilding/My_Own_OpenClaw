...
- [Electron Wakeword Bridge and Audio Framing Reference](../frontend/local_runtime_python/wakeword_bridge_and_audio_framing_reference.md)
- [Wakeword Service Model Bootstrap and Binary Framing Reference](../frontend/local_runtime_python/services/wakeword_service_model_bootstrap_and_binary_framing_reference.md)
