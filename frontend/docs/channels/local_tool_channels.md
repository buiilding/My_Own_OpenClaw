...
- [Local-Runtime Python Implementation and Memory](../frontend/local_runtime_python/local_runtime_python_and_memory.md)
- [Local-Runtime JSON-RPC Protocol Reference](../frontend/local_runtime_python/core/json_rpc_protocol_stdout_framing_and_shutdown_signal_runtime_reference.md)
