...
| Tool call appears but local action does not run | SDK runtime tool router or local-runtime Python executor | [Local Tool Channels](local_tool_channels.md), [Tool Execution Lifecycle](../tools/tool_execution_lifecycle.md) |
...
| SDK route works but desktop action fails | hosted SDK vs local-runtime split | [SDK Hub](../sdk/README.md), [Local Tool Channels](local_tool_channels.md) |
