...
| Electron main | Windows, overlays, SDK-runtime adapter, config persistence, local-runtime host adapters, permissions, wakeword bridge | `frontend/src/main` | [Frontend Main Docs Hub](../frontend/main/README.md), [Main Process Change Workflow](../frontend/main/main_process_change_workflow.md), [Local Runtime Process Lifecycle Change Workflow](../frontend/main/local_runtime/process_lifecycle_change_workflow.md), [Frontend Runtime Docs Hub](../frontend/runtime/README.md), [IPC Change Workflow](../frontend/ipc_change_workflow.md) |
...
- [Desktop and Local Runtime Node](../nodes/desktop_and_local_runtime_node.md)
