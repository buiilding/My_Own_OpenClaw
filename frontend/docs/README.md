...
- [**Frontend Local Runtime Process Lifecycle + Request Correlation**](frontend/main/local_backend/local_runtime_readiness_and_helper_rpc_reference.md) - Local-runtime Python startup env/path resolution, readiness retry token guards, timeout/pending map semantics, and reset/shutdown behavior
- [**Frontend Local Runtime RPC Handler Registry Runtime**](frontend/main/local_backend/local_runtime_rpc_handler_registry_reference.md) - Direct and compiled handler registration contracts, payload mapping modes, and test-backed channel/method invariants
