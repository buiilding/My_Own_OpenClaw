...
Use [Local Runtime JSON-RPC Change Workflow](../../local_runtime_python/local_runtime_jsonrpc_change_workflow.md)
...
| Python method exists but payload maps incorrectly | IPC/JSON-RPC contract, not lifecycle | [Local Runtime JSON-RPC Change Workflow](../../local_runtime_python/local_runtime_jsonrpc_change_workflow.md) |
...
- [SDK-Owned Local-Runtime Lifecycle Reference](../../local_runtime_python/local_runtime_lifecycle_reference.md)
- [Local Runtime JSON-RPC Change Workflow](../../local_runtime_python/local_runtime_jsonrpc_change_workflow.md)
- [Local-Runtime Python Implementation Change Workflow](../../local_runtime_python/local_runtime_python_change_workflow.md)
