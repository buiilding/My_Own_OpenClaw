...
- [Main Local-Runtime Docs Hub](main/local_runtime/README.md)
- [Local-Runtime Process Lifecycle Change Workflow](main/local_runtime/process_lifecycle_change_workflow.md)
...
- [Local-Runtime Process Lifecycle, Readiness, and Request-Correlation Reference](main/local_runtime/local_runtime_readiness_and_helper_rpc_reference.md)
- [Local-Runtime RPC Handler Registry Reference](main/local_runtime/local_runtime_rpc_handler_registry_reference.md)
...
- [Local-Runtime Core Docs Hub](local_runtime_python/core/README.md)
- [Local-Runtime Services Docs Hub](local_runtime_python/services/README.md)
- [Local-Runtime Source Maps Docs Hub](local_runtime_python/source_maps/README.md)
- [Local-Runtime System-State Docs Hub](local_runtime_python/system_state/README.md)
- [Local-Runtime Tools Docs Hub](local_runtime_python/tools/README.md)
- [Local-Runtime Tool Registry Docs Hub](local_runtime_python/tools/registry/README.md)
- [Local-Runtime Computer Tools Docs Hub](local_runtime_python/tools/computer/README.md)
- [Local-Runtime System Tools Docs Hub](local_runtime_python/tools/system/README.md)
- [Local Runtime Memory Docs Hub](local_runtime_python/memory/README.md)
- [Local Runtime Memory Storage Docs Hub](local_runtime_python/memory/storage/README.md)
- [Local-Runtime Python and Memory](local_runtime_python/local_runtime_python_and_memory.md)
- [Local Runtime JSON-RPC Change Workflow](local_runtime_python/local_runtime_jsonrpc_change_workflow.md)
- [Local-Runtime System-State Collection and Platform Adapter Reference](local_runtime_python/system_state/system_state_collection_and_platform_adapter_reference.md)
- [Local-Runtime Tool Catalog and Execution Model](local_runtime_python/tool_catalog_and_execution_model.md)
- [Local-Runtime Shell and Process Session Runtime Reference](local_runtime_python/tools/shell_and_process_session_runtime_reference.md)
- [Local-Runtime Filesystem Read and Replace Runtime Reference](local_runtime_python/tools/filesystem_read_replace_runtime_reference.md)
- [Local-Runtime Registry and Result Contract](local_runtime_python/tools/registry/tool_registry_exposed_schema_and_result_contract_reference.md)
- [Local-Runtime Mouse, Keyboard, Scroll, and Screenshot Runtime Reference](local_runtime_python/tools/computer/mouse_keyboard_scroll_and_screenshot_runtime_reference.md)
- [Local-Runtime Wait, Window, and Stats Runtime Reference](local_runtime_python/tools/system/wait_window_stats_runtime_reference.md)
- [Memory Pipeline and Summarization](local_runtime_python/memory_pipeline_and_summarization.md)
- [Local-Runtime Summarizer Watermark and Conversation Batch Reference](local_runtime_python/memory/summarizer_watermark_and_conversation_batch_reference.md)
- [Local Runtime Memory Store Embedding, Search, and Memory-Type Routing Reference](local_runtime_python/memory/storage/local_memory_store_embedding_search_and_memory_type_routing_reference.md)
- [Local Runtime SQLite Schema Migration, FAISS Index I/O, and Watermark State Reference](local_runtime_python/memory/storage/sqlite_schema_migration_faiss_index_and_watermark_state_reference.md)
- [Local-Runtime Browser Docs Hub](local_runtime_python/browser/README.md)
- [Local-Runtime Browser Contracts Docs Hub](local_runtime_python/browser/contracts/README.md)
- [Local-Runtime Browser Chrome Docs Hub](local_runtime_python/browser/chrome/README.md)
- [Browser Automation Stack](local_runtime_python/browser_automation_stack.md)
- [Browser Action Runtime Reference](local_runtime_python/browser_action_runtime_reference.md)
- [Schema Registry and Action Validation Boundary Reference](local_runtime_python/browser/contracts/schema_registry_and_action_validation_boundary_reference.md)
- [Chrome Detection, Launcher, and CDP Session Reference](local_runtime_python/browser/chrome/chrome_detection_launcher_and_cdp_session_reference.md)
...
- [JSON-RPC Protocol and Stdout Framing Reference](local_runtime_python/core/json_rpc_protocol_stdout_framing_and_shutdown_signal_runtime_reference.md)
- [Backend Config Env-Precedence Reference](local_runtime_python/core/backend_config_env_precedence_trailing_slash_normalization_and_default_url_contract_reference.md)
- [Remote Semantic Client Reference](local_runtime_python/core/remote_semantic_client_summarize_payload_timeout_and_error_surface_contract_reference.md)
...
- [Local-Runtime Python Folder Topology and Package `__init__` Export Surface Reference](local_runtime_python/source_maps/local_runtime_python_folder_topology_and_package_init_export_surface_reference.md)
