...
```bash
<windie> test local-runtime frontend/tests/sidecar/test_memory_operations.py frontend/tests/sidecar/test_conversation_search_helpers.py frontend/tests/sidecar/test_chat_event_store.py -q
```
...
```bash
<windie> test local-runtime frontend/tests/sidecar/test_memory_summarizer.py frontend/tests/sidecar/test_conversation_semanticization_runtime.py frontend/tests/sidecar/test_remote_semantic_client.py -q
private backend tests private backend tests -q
```
...
```bash
<windie> test local-runtime frontend/tests/sidecar/test_local_backend.py frontend/tests/sidecar/test_chat_event_store.py -q
private backend tests private backend tests -q
```
