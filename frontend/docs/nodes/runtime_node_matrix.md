...
| --- | --- | --- | --- |
| local-runtime JSON-RPC | SDK `LocalRuntime` with Electron host context | local-runtime Python executor | [Local Tool Channels](../channels/local_tool_channels.md), [Local-Runtime JSON-RPC Protocol Reference](../frontend/local_runtime_python/core/json_rpc_protocol_stdout_framing_and_shutdown_signal_runtime_reference.md) |
...
| wakeword subprocess frames | renderer/main wakeword bridge | local-runtime wakeword helper backed by the Python service | [Voice and Audio Channels](../channels/voice_and_audio_channels.md), [Electron Wakeword Bridge and Audio Framing Reference](../frontend/local_runtime_python/wakeword_bridge_and_audio_framing_reference.md) |
