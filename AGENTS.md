...
- Extension tools must use `extensions/<id>/extension.json` for schema, prompt-layer, and Python entrypoint contributions. Ordinary extension tools should not edit the built-in sidecar registry or manifest modules
