...
- test(ghost-screen-click): replace browser visual harness with hard-coded real screen test script (`scripts/test-ghost-screen-click.py`) and frontend launcher `npm run test:ghost-screen` for manual 1920x1080 top-to-bottom cursor move + click verification (`--dry-run` supported)
