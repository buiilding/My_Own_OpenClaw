...
- frontend/main: make dismissed or hidden response overlay windows explicitly
  click-through before hiding them, so an invisible native response overlay
  cannot block clicks behind the minimal chat pill.
