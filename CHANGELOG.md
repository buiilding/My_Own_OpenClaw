...
- test(ghost-cursor): add single WindieOS ghost-cursor animation test launcher `npm run test:ghost-cursor` (OS overlay in Electron, no real cursor movement/click) backed by `tool-ghost-debug` response window mode and timeline regression coverage
